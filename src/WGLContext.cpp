...
WGLContext* WGLContext::create(GLOSWindowWin32* window)
{
...
bool WGLContext::init(GLOSWindowWin32* window)
{
	_hDC = window->getDC();
	if (!_hDC)
		return false;
...
int WGLContext::choosePixelFormat(GLOSWindowWin32* window, const FBConfig& fbConfig)
{
